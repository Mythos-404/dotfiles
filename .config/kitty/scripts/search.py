"""
FORM: https://github.com/trygveaa/kitty-kitten-search
"""
...
class Search(Handler):
    def __init__(self, cached_values: dict[str, str], window_ids: list[int], error: str = "") -> None:
    ...
    def on_resize(self, _: ScreenSize) -> None:
        self.refresh()
    ...
    def quit(self, return_code: int) -> None:
        ...
        call_remote_control(["resize-window", "--self", "--axis=reset"])
